...
@Component({
    ...
    templateUrl: './haalcentraal-kvk-plugin-configuration.component.html',
    styleUrls: ['./haalcentraal-kvk-plugin-configuration.component.scss']
})
export class HaalcentraalKvkPluginConfigurationComponent
