...
import {DocumentenApiConfig, PluginConfigurationComponent, PluginManagementService, PluginTranslationService} from '@valtimo/plugin';


@Component({
    selector: 'custom-documenten-api-configuration',
    templateUrl: './custom-documenten-api-configuration.component.html',
    styleUrls: ['./custom-documenten-api-configuration.component.scss']
})
export class CustomDocumentenApiConfigurationComponent
