...
@Component({
    ...
    selector: 'custom-objecten-api-plugin',
    templateUrl: './custom-objecten-api-plugin-configuration.component.html',
    styleUrls: ['./custom-objecten-api-plugin-configuration.component.scss']
})
export class CustomObjectenApiPluginConfigurationComponent
