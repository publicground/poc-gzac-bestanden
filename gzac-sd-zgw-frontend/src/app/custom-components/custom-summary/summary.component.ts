...
/**
 * TODO:
 * Component has extra polling functionality from valtimo 12.
 * When the upgrade to valtimo 12 is complete this component can be removed.
 */
@Component({
...
export class CustomSummaryComponent implements OnInit, OnDestroy {
  ...
  public loadProcessDocumentInstances(documentId: string): void {
    this._subscriptions.add(
      this.documentService
        ...
        .pipe(repeat({count: 10, delay: 3000}))
