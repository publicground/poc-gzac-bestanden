...
class SamlTokenWebClient(
    private val webclientFactoryHelper: WebclientFactoryHelper
)  {

    fun getToken(config: ClientConfig): String {
    ...
    private fun webClient(clientConfig: ClientConfig): WebClient {

        val httpClient = webclientFactoryHelper.httpClient(clientConfig)

        return WebClient.builder()
            .clientConnector(ReactorClientHttpConnector(httpClient))
            .baseUrl(clientConfig.tokenServiceUrl)
