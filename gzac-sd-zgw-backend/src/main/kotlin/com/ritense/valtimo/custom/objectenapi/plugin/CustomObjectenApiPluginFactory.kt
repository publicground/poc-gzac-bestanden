...
class CustomObjectenApiPluginFactory(
    pluginService: PluginService,
    private val objectManagementFacade: ObjectManagementFacade
) : PluginFactory<CustomObjectenApiPlugin>(pluginService) {

    override fun create(): CustomObjectenApiPlugin {
        return CustomObjectenApiPlugin(
