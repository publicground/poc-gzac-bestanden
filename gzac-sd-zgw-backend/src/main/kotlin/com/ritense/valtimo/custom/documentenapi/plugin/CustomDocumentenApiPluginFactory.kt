...
class CustomDocumentenApiPluginFactory(
    pluginService: PluginService,
    private val customDocumentenApiService: CustomDocumentenApiService
) : PluginFactory<CustomDocumentenApiPlugin>(pluginService) {

    override fun create(): CustomDocumentenApiPlugin {
        return CustomDocumentenApiPlugin(
